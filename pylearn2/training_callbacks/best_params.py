...
class KeepBestParams(TrainingCallback):
    """
    A callback which keeps a model's best parameters based on its performance
    on a given cost with a given dataset.
    """
    def __init__(self, model, cost, monitoring_dataset, batch_size):
        ...
        model : pylearn2.models.model.Model
            the model whose best parameters we want to keeps
        cost : tensor_like
