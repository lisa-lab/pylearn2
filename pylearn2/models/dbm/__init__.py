...
class Layer(Model):
    ...
    def _apply_constraints(self, updates):
        ...
        updates : dictionary
            ...
            will be the same object, after being modified in-place (the
            value of `updates[constrain_on]` will be changed to reflect
            the value after applying the constraint).
