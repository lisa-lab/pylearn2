...
class Softmax(Layer):
    ...
    def __init__(self, n_classes, layer_name, irange=None,
        ...
        ----------
        bias_init : object
            The (new-interface) Initialization object to use for
        ...
        if not no_affine:
            ...
            if self.bias_init is None:
                ...
                if init_bias_target_marginals:
                    ...
                    pinv = pseudoinverse_softmax_numpy(marginals)
                    b = pinv.astype(self.b.dtype)
                    assert b.ndim == 1
    ...
    def censor_updates(self, updates):
        ...
        if self.max_row_norm is not None:
            ...
            if W in updates:
                ...
                unshuffled = updated_W * (desired_norms / (1e-7 + row_norms))
                updates[W] = unshuffled.dimshuffle(0, 'x')
    ...
    def censor_updates(self, updates):
        ...
        if self.max_kernel_norm is not None:
            ...
            if W in updates:
                ...
                unshuffled = updated_W * (desired_norms / (1e-7 + row_norms))
                updates[W] = unshuffled.dimshuffle(0, 'x', 'x', 'x')
