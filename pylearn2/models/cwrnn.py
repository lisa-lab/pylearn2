"""
Implementation of Clockwork Recurrent Neural Network
of paper "A Clockwork RNN" in ICML 2014.
"""
...
class CWRNN(Model):
    """
    A class of Model using multi-scaled approaches for RNN.
    CWRNN has multiple modules in its hidden layer,
    operating with different time-scales.
    So far exponential scaled period is implemented.
    """
    ...
    def gprop(self, state_below, n_steps=None):
        ...
        fn = lambda i, h, it: self.gprop_step(i, h, it)
    ...
    def gprop_step(self, index, state_before, iterator):
...
class Recurrent(Linear):
    ...
    def set_input_space(self, space):
        ...
        if self.num_modules == 1:
            ...
            if isinstance(self.dim, list):
                ...
                # Currently we could not define different size for each module
                # This part of the code should be generalized
    ...
    def fprop_step(self, state_below, index, state_before, W, U):
        ...
        index = T.mod(index, self.num_modules) + 1
