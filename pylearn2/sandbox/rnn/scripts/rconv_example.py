...
from pylearn2.sandbox.rnn.models.mlp import RecursiveConvolutionalLayer
from pylearn2.space import VectorSpace

mlp = MLP(layers=[Tanh(dim=25, layer_name='pre_rnn', irange=0.01),
                  RecursiveConvolutionalLayer(dim=25, layer_name='recurrent', irange=0.01),
                  Tanh(dim=25, layer_name='h', irange=0.01)],
