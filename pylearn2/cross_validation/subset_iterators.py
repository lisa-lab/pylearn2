...
class ValidationKFold(KFold):
    ...
    def __iter__(self):
        ...
        """
        # Use the test set from the next fold as the validation set for
        # this fold. Since the test sets are chosen sequentially by KFold,
        # the test set for the next fold will never contain any indices
        # from the current test set.
